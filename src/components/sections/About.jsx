        ...
        <section className="mt-5 max-w-4xl mx-auto md:px-8" id="about">
            ...
            <div className="text-secondary-text md:flex flex-row gap-16 px-4 md:px-0" ref={ref}>
                <motion.div
                    ...
                    <p className="pb-3">
                        Hey there! I'm Aicha Atki, a software developer based in Morocco. I specialize in backend development, particularly using Django, and Python, but I'm also comfortable with various tools and adapt to project needs. I also have experience in frontend development.
                    </p>
